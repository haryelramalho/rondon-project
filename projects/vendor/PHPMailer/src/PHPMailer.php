...
class PHPMailer
{
    ...
    {
        //phpmailer configurations initializing
        $this->setLanguage("br");
        $this->isSMTP();
        $this->SMTPDebug = 0;
        $this->SMTPAuth = true;
        $this->SMTPSecure = 'ssl';
        $this->Host = 'br994.hostgator.com.br';
        $this->Port = 465;
        $this->CharSet = 'utf-8';
        $this->Username = 'contato@rederondonbahia.com.br';
        $this->Password = 'z@JbQxf8kE]S';
        $this->AltBody = "Para conseguir visualizar essa mensagem corretamente, favor utilizar um visualizador de e-mail com suporte para HTML.";
